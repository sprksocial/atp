...
import { decode, decodeAll, encode } from "./encoding.ts";

export { hasher };
export { decode, decodeAll, encode };
...
export function decodeCidFromBytes(bytes: Uint8Array): Cid {
  return decodeCid(bytes);
}
