import { ensureValidCidString, isLanguage } from "@atp/data";
import {
  ensureValidAtUri,
  ensureValidDatetime,
  ensureValidDid,
...
export type InferStringFormat<F> =
  //
  F extends "datetime" ? Datetime
    : F extends "uri" ? Uri
    : F extends "at-uri" ? AtUri
    : F extends "did" ? Did
    : F extends "handle" ? Handle
    : F extends "at-identifier" ? AtIdentifier
    : F extends "nsid" ? Nsid
    : string;
