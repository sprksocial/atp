...
export type InferRecordKey<R extends RecordSchema> = R extends
  RecordSchema<infer K> ? RecordKeySchemaOutput<K>
  : never;
...
export type RecordKeySchemaOutput<Key extends LexiconRecordKey> = Key extends
  "any" ? string
  : Key extends "tid" ? TidString
  : Key extends "nsid" ? NsidString
