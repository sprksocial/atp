...
import type { Restricted, UnknownString } from "../core.ts";
import {
  type Infer,
...
export class TypedUnionSchema<
  TypedRefs extends readonly TypedRefSchema[] = TypedRefSchema[],
  Closed extends boolean = boolean,
> extends Validator<TypedUnionSchemaOutput<TypedRefs, Closed>> {
  override readonly lexiconType = "union" as const;
