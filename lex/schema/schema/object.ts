...
import type { Simplify } from "../core.ts";
import {
  type Infer,
...
export type ObjectSchemaProperties = { [_ in string]: Validator };
export type ObjectSchemaOptions = {
  required?: readonly string[];
  nullable?: readonly string[];
  unknownProperties?: "strict" | DictSchema<Validator, Validator>;
};
...
export class ObjectSchema<
  const Validators extends ObjectSchemaProperties = ObjectSchemaProperties,
  const Options extends ObjectSchemaOptions = ObjectSchemaOptions,
