...
import type { ObjectSchemaPropertiesOutput } from "./object.ts";
...
export type InferParamsSchema<T> = T extends ParamsSchema<infer P, infer O>
...
> extends Validator<Output> {
  override readonly lexiconType = "params" as const;
