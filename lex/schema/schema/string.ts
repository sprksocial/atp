import { CID, graphemeLen, utf8Len } from "@atp/data";
import {
  assertStringFormat,
...
export class StringSchema<
  const Options extends StringSchemaOptions = StringSchemaOptions,
> extends Validator<StringSchemaOutput<Options>> {
  override readonly lexiconType = "string" as const;
